    ...
    <div>
        <Flex className="header-content">
          ...
          <div className="header-content_title">
              <h1>SAMSUNG</h1><span>50" QLED 4K Q60B</span>
            </div>
             
                <Button className="header-content_btn">{translate("all")}</Button>
                 <div className="header-content_text">
              <p>c рассрочкой 0% <div>0-0-12</div></p>
            </div> 
...
<Carousel autoplay>
               <div className="header-content_img-one" style={contentStyle}>
                <img src={TV} alt="TV"/>
              </div>
            <div className="header-content_img-two" style={contentStyle}>
              <img src={Machine} alt="Machine" />
              </div>
             <div className="header-content_img-three" style={contentStyle}>
