...
import { cardPage, cardPageFour, cardPageThree, cardPageTwo } from "../../constants/menu";
  ...
  return (
      <div className='sport-page_cards'>
          ...
          <div className='sport-page_cards-pagination'>
              ...
              <Button className="sport-page_cards-pagination_btn">{translate("again")}</Button>
          </div>
          <Button className="sport-page_cards-btn"><Icons.bestArrow /></Button>
      </div>
  );
}
